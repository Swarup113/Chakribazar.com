...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/background.jpeg');" >
			
				<div class="container">
					<p>Just a click away from making your day!</p>
					
					<p>Welcome to Chakribazar! Find out the best job through Chakribazar! </p>
